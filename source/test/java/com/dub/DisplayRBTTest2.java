...
public class DisplayRBTTest2 {
	...
	public static void main(String[] args) {
		...
		String status = tree.checkInsert(42, results);
		
		System.out.println("status " + status);
		tree.inOrderWalk(tree.getRoot());
		
		System.out.println(tree.checkInsert(95, results));
		System.out.println(tree.checkInsert(96, results));
		System.out.println(tree.checkInsert(97, results));
		System.out.println(tree.checkInsert(98, results));
